    ...
    return (
        <div className="row mb-2 all-stories-in-the-home-page mx-1"  style={{overflowX:"scroll"}}>
            ...
            <div className="col-9   stories-in-home d-flex ">
                <FollowersStories
                    image="https://www.success.com/wp-content/uploads/2016/09/therealreasontravelingmakesyouhappy.jpg"
                    profilePic="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
                    title="Shafeek Waafi" />
